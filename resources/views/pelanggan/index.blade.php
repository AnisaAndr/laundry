                     ...
                     <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Data Pelanggan
                                    <a href="{{ route('pelanggan.create')}}" class="btn btn-primary float-right">Tambah</a>
                                </div>
                                <!-- /.panel-heading -->
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('pelanggan.edit', $data->id)}}" class="btn btn-success float-right">Ubah</a>
                                                        <a href="{{route('pelanggan.show', $data->id)}}" class="btn btn-warning float-right">Tampil</a>
