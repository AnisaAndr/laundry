                    ...
                    <div class ="col-lg-12">
                        ...
                        <div class="panel-body">
                           ...
                           <select name="id_karyawan" class="form-control">
                             ...
                             <div class="panel-body">
                            <label>Qty</label>
                            <input type="text" class="form-control" name="qty" value="{{$transaksi->qty}}">
                             </div>
                              <div class="panel-body">
                            <label>Harga</label>
                            ...
                            <input type="text" class="form-control" name="tgl_cuci" value="{{$transaksi->tgl_cuci}}">
                             </div>
                              <div class="panel-body">
                            <label>Tanggal Selesai</label>
                            <input type="text" class="form-control" name="tgl_selesai" value="{{$transaksi->tgl_selesai}}">
                             </div>
